        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link
              ...
              className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow border-2 border-red-500"
            >
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <h3 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                      Lead Scoring
                      <span className="px-2 py-0.5 bg-red-100 text-red-800 text-xs font-semibold rounded">NEW</span>
                    </h3>
                    <p className="text-sm text-gray-500">
                      AI-powered lead prioritization system
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Link
              href="/admin/projects"
              className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow border-2 border-indigo-500"
            >
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <h3 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                      Project Management
                      <span className="px-2 py-0.5 bg-indigo-100 text-indigo-800 text-xs font-semibold rounded">NEW</span>
                    </h3>
                    <p className="text-sm text-gray-500">
                      Track projects from booking to delivery
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Link
              ...
              className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow border-2 border-green-500"
            >
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <h3 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                      Enhanced Content CMS
                      <span className="px-2 py-0.5 bg-green-100 text-green-800 text-xs font-semibold rounded">NEW</span>
                    </h3>
                    <p className="text-sm text-gray-500">
                      Advanced content editor with SEO, scheduling, revisions & more
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Link
              ...
              className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow border-2 border-blue-300"
            >
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Run schema updates and migrations
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Link
              ...
              className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow border-2 border-pink-500"
            >
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <h3 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                      Marketing & CRM
                      <span className="px-2 py-0.5 bg-pink-100 text-pink-800 text-xs font-semibold rounded">NEW</span>
                    </h3>
                    <p className="text-sm text-gray-500">
                      Email & SMS campaigns, lead nurturing
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Two-way SMS messaging with leads
                    </p>
                  </div>
                </div>
              </div>
