    ...
    <main className="min-h-screen bg-stone-50 pt-20">
      <section className="bg-stone-950 py-16 text-white md:py-20">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          ...
          <h1 className="text-4xl font-bold leading-tight md:text-6xl">See galleries that match your project.</h1>
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-stone-200">
            Tell us what you are planning and we will send a complete gallery or a tailored portfolio instead of making you sort through unrelated work.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto grid max-w-6xl gap-8 px-4 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <div>
            ...
            <ul className="mt-5 space-y-3 text-stone-700">
              <li>Complete galleries when you need to inspect consistency.</li>
              <li>Tailored examples by service, venue style, lighting, or project goal.</li>
              <li>Delivery expectations, editing style, and next-step recommendations.</li>
            </ul>
          </div>
