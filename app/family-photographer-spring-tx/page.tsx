  ...
  return (
    <ServiceCityLandingPage
      ...
      highlights={[
        ...
        { title: 'Two-Photographer Coverage', description: 'Every Studio37 session includes two photographers to capture multiple angles and candid moments across the full family group simultaneously.' },
      ...
      faqs={[
        ...
        { question: 'How many people can be in a family session?', answer: 'We accommodate all family sizes. Large extended family groups benefit from our standard two-photographer workflow for full coverage.' },
