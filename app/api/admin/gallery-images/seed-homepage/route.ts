  ...
  try {
    ...
    const TARGET_IMAGES = [
      ...
      },
      {
        ...
        title: 'Wedding Coverage Detail',
        alt_text: 'Studio37 wedding photography coverage detail',
        description: 'Wedding-day coverage with attention to people, details, and timing.',
        category: 'homepage',
        featured: true,
      },
      {
        ...
        alt_text: 'Studio37 outdoor portrait session with warm natural light',
      ...
      },
      {
        ...
        alt_text: 'Studio37 client portrait with polished professional editing',
        description: 'Polished portrait direction for personal and professional use.',
        category: 'homepage',
        featured: true,
      },
    ] as const
