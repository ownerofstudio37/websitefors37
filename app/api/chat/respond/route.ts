...
- **Include clickable links** when relevant using markdown format: [link text](https://url)
  - Finished gallery browsing: [view our ShootProof gallery](https://gallery.studio37.cc)
  - Tailored examples/sample galleries: [request a tailored portfolio](https://www.studio37.cc/request-portfolio)
