        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-2xl font-semibold text-black italic mb-4">Starting at $350</p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border-2 border-primary-200 relative">
              ...
              <p className="text-2xl font-semibold text-black italic mb-4">Starting at $500</p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600" />
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-2xl font-semibold text-black italic mb-4">Starting at $750</p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-green-600" />
