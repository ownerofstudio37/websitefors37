...
export const adminRouteOwnership: AdminRouteOwnership[] = [
  ...
  { route: '/admin/content-enhanced', file: 'app/admin/content-enhanced/page.tsx', status: 'primary', owner: 'content', note: 'Canonical content-only editor for copy, SEO, blog/page content, scheduling, and revisions.' },
  ...
  { route: '/admin/ai-site-builder', file: 'app/admin/ai-site-builder/page.tsx', status: 'legacy', owner: 'content', note: 'AI draft generator kept for compatibility; fold generation into Visual Page Builder.' },
  { route: '/admin/page-builder', file: 'app/admin/page-builder/page.tsx', status: 'primary', owner: 'content', note: 'Canonical WYSIWYG builder for hardcoded routes, CMS routes, and premium visual sections.' },
  ...
  { route: '/admin/editor/layout', file: 'app/admin/editor/layout/page.tsx', status: 'utility', owner: 'content', note: 'Route-layout utility retained behind Visual Page Builder for replace/prepend/append recovery; not a primary CMS entry.' },
