...
export const ADMIN_TOOLS: AdminTool[] = [
  ...
  },
  {
    id: 'page-builder',
    label: 'Page Builder',
    description: 'Advanced builder for custom layouts and experimental page workflows.',
    href: '/admin/page-builder',
    icon: Workflow,
    group: 'content',
    keywords: ['builder', 'layout', 'advanced', 'custom page'],
    badge: 'Advanced',
    showInSidebar: false,
    showOnDashboard: false,
  },
  {
    ...
    description: 'Fast visual edits for existing published pages.',
  ...
  },
  {
    ...
    icon: Workflow,
    group: 'content',
    keywords: ['visual', 'builder', 'layout', 'advanced'],
    badge: 'Advanced',
    showInSidebar: false,
    showOnDashboard: false,
  },
