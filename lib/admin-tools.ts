...
export const ADMIN_TOOLS: AdminTool[] = [
  ...
  },
  {
    ...
    description: 'Content-only CMS for pages, blog copy, SEO fields, scheduling, revisions, and templates.',
  ...
  },
  {
    ...
    description: 'Primary WYSIWYG builder for existing public pages, landing pages, and premium visual sections.',
  ...
  },
  {
    ...
    description: 'Legacy route picker now folded into Visual Page Builder.',
    href: '/admin/editor/layout',
    icon: LayoutTemplate,
    group: 'content',
    keywords: ['cms', 'route editor', 'layout editor', 'public pages', 'publish', 'draft'],
    badge: 'Legacy',
    showInSidebar: false,
    showOnDashboard: false,
  },
  ...
  },
  {
    ...
    description: 'Legacy AI draft generator. Future AI generation should live inside Visual Page Builder.',
