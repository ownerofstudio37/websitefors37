...
import { Bell, X, CheckCheck, Calendar, MessageSquare, Mail } from 'lucide-react'
import Link from 'next/link'

interface Notification {
  id: string
  type: 'lead' | 'appointment' | 'message'
  title: string
  message: string
  timestamp: string
  read: boolean
        ...
        <div className={`absolute ${
          dropdownAlign === 'sidebar' 
            ...
            : dropdownAlign === 'left' 
              ? 'left-0 mt-2' 
              : 'right-0 mt-2'
        } w-full max-w-sm sm:w-96 bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-[600px] flex flex-col`}>
          {/* Header */}
