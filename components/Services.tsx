...
const services = [
		...
		},
		{
			...
			description:
				'Full-service growth support for custom websites, SEO, PPC, social systems, and content strategy. For photo-only refreshes, start with Commercial Photography.',
