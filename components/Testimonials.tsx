							...
							<div className="flex items-center justify-between">
								...
								{testimonial.source && testimonial.sourceUrl && (
									<a 
										...
										className="ml-4 px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full whitespace-nowrap hover:bg-blue-200 transition-colors"
									>
										{testimonial.source}
									</a>
								)}
								{testimonial.source && !testimonial.sourceUrl && (
									<span className="ml-4 px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full whitespace-nowrap">
										{testimonial.source}
									</span>
								)}
							</div>
