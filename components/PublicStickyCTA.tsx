...
export default function PublicStickyCTA() {
  ...
  return (
    <div data-mobile-nav-hide className="fixed inset-x-0 bottom-0 z-30 border-t border-stone-200 bg-white/95 pb-[env(safe-area-inset-bottom)] shadow-[0_-10px_30px_rgba(15,23,42,0.08)] backdrop-blur-xl md:hidden">
      <nav className="grid grid-cols-3" aria-label="Quick actions">
        ...
        <Link href="https://gallery.studio37.cc" className="flex min-h-[64px] flex-col items-center justify-center gap-1 px-2 text-center text-xs font-semibold text-stone-900">
