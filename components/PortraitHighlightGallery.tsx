  ...
  const staticImages: Pick<GalleryImage, 'id' | 'title' | 'description' | 'image_url' | 'alt_text'>[] = [
    {
      ...
      description: 'Graduation portraits with clean posing and natural light.',
      alt_text: 'Studio37 senior portrait session with outdoor natural light',
      image_url: 'https://res.cloudinary.com/dmjxho2rl/image/upload/v1780810835/Katies_Grad_Shoot_-_77_1_convert.io_ayhrsi.jpg',
    },
    {
      id: 'cloudinary-2',
      title: 'Brand Portrait Detail',
      description: 'Commercial portrait styling for polished business use.',
      alt_text: 'Studio37 commercial brand portrait detail for business content',
      image_url: 'https://res.cloudinary.com/dmjxho2rl/image/upload/v1778033154/Untitled-8_2_b18mim.jpg',
    },
    {
      id: 'cloudinary-3',
      title: 'Editorial Portrait',
      description: 'Directed portrait work with a warm Studio37 edit.',
      alt_text: 'Studio37 editorial portrait with warm professional editing',
      image_url: 'https://res.cloudinary.com/dmjxho2rl/image/upload/v1778033152/Untitled-15_vyz4oa.jpg',
    },
    {
      id: 'cloudinary-4',
      title: 'Family Session Moment',
      description: 'Relaxed family coverage built around real connection.',
      alt_text: 'Studio37 family photography session with relaxed outdoor direction',
      image_url: 'https://res.cloudinary.com/dmjxho2rl/image/upload/v1779268255/Untitled-3_2_u4p9kx.jpg',
    },
    {
      id: 'cloudinary-5',
      title: 'Studio Portrait',
      description: 'Polished portrait lighting for personal and professional use.',
      alt_text: 'Studio37 studio portrait with polished professional lighting',
      image_url: 'https://res.cloudinary.com/dmjxho2rl/image/upload/v1778033085/KELLY_-_1_8_1__2_x7leuc.jpg',
    },
    {
      id: 'cloudinary-6',
      title: 'Golden-Hour Portrait',
      description: 'Outdoor portrait work planned around flattering light.',
      alt_text: 'Studio37 golden-hour outdoor portrait session',
