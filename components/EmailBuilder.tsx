...
export const EMAIL_TEMPLATE_PRESETS: Record<string, { label: string; description: string; blocks: Omit<EmailBlock, 'id'>[] }> = {
  'lead-follow-up-day1': {
    ...
    blocks: [
      ...
      { type: 'text', content: { text: 'In the meantime, you can preview our featured public work or request complete galleries tailored to your project type.\nWe can\'t wait to hear your vision.' } },
      { type: 'button', content: { text: '🖼️ Request Complete Galleries', url: 'https://www.studio37.cc/request-portfolio', backgroundColor: '#374151', textColor: '#ffffff', align: 'center' } },
      { type: 'social', content: {} },
      { type: 'footer', content: {} },
    ],
  },
  ...
  'outreach': {
    ...
    blocks: [
      { type: 'logo', content: { tagline: 'Studio37 Photography' } },
      { type: 'hero', content: { title: 'Your Story Deserves to Be Told Beautifully', subtitle: 'Award-winning photography in Houston & beyond.', backgroundColor: '#1a1a1a', textColor: '#ffffff', buttonText: 'Request Complete Galleries', buttonUrl: 'https://www.studio37.cc/request-portfolio', buttonColor: BRAND.gold } },
  ...
  'newsletter': {
    ...
    blocks: [
      ...
      { type: 'text', content: { text: '✨ Featured Session\n\nThis month\'s feature is a stunning golden-hour engagement session at Hermann Park. The couple\'s chemistry was electric — request a tailored gallery set if you want to review complete examples.' } },
      { type: 'button', content: { text: 'Request Complete Galleries', url: 'https://www.studio37.cc/request-portfolio', backgroundColor: BRAND.primary, textColor: '#ffffff', align: 'center' } },
      { type: 'divider', content: {} },
