...
export const EMAIL_TEMPLATE_PRESETS: Record<string, { label: string; description: string; blocks: Omit<EmailBlock, 'id'>[] }> = {
  'lead-follow-up-day1': {
    ...
    blocks: [
      ...
      { type: 'button', content: { text: '🖼️ View Our Portfolio', url: 'https://gallery.studio37.cc', backgroundColor: '#374151', textColor: '#ffffff', align: 'center' } },
      { type: 'social', content: {} },
      { type: 'footer', content: {} },
    ],
  },
  ...
  'outreach': {
    ...
    blocks: [
      { type: 'logo', content: { tagline: 'Studio37 Photography' } },
      { type: 'hero', content: { title: 'Your Story Deserves to Be Told Beautifully', subtitle: 'Award-winning photography in Houston & beyond.', backgroundColor: '#1a1a1a', textColor: '#ffffff', buttonText: 'See Our Work', buttonUrl: 'https://gallery.studio37.cc', buttonColor: BRAND.gold } },
  ...
  'newsletter': {
    ...
    blocks: [
      ...
      { type: 'button', content: { text: 'View Full Gallery', url: 'https://gallery.studio37.cc', backgroundColor: BRAND.primary, textColor: '#ffffff', align: 'center' } },
      { type: 'divider', content: {} },
