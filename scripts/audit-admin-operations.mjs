...
const markerChecks = [
  ...
  { file: 'app/admin/chatbot-training/page.tsx', markers: ['AdminConfirmDialog', 'Custom Q&A entries remain separate', 'Recent Answer Feedback'] },
  ...
  { file: 'app/api/chat/respond/route.ts', markers: ['view featured work', 'request complete galleries', 'imageAnalysisContext', 'fallback', 'getPackageFactsPrompt', 'routeChatbotIntent'] },
  { file: 'lib/chatbot-quality.ts', markers: ['chatbotFactCases', '3 hours', 'request complete galleries', 'chatbotFallbacks'] },
  { file: 'app/api/chat/feedback/route.ts', markers: ['chatbot_feedback', 'rating', 'botResponse'] },
