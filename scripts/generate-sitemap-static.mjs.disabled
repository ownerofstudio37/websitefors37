...
const staticUrls = [
  ...
  { url: `${baseUrl}/local-photographer-new-waverly-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-katy-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-katy-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-the-woodlands-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-conroe-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/family-photographer-magnolia-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/headshot-photographer-houston-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-tomball-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/family-photographer-spring-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-montgomery-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-willis-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-huntsville-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/family-photographer-new-caney-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-hockley-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/family-photographer-porter-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-splendora-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/family-photographer-cleveland-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-waller-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-plantersville-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-navasota-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-bryan-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/wedding-photographer-college-station-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-cypress-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-new-waverly-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/family-photographer-kingwood-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/portrait-photographer-humble-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/family-photographer-atascocita-tx`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/spring`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/montgomery`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/willis`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/huntsville`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/new-caney`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/hockley`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/porter`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/splendora`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/cleveland`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/waller`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/plantersville`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/navasota`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/bryan`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/college-station`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/cypress`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/kingwood`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/atascocita`, priority: 0.8, frequency: 'monthly' },
  { url: `${baseUrl}/new-waverly`, priority: 0.8, frequency: 'monthly' },
  ...
  { url: `${baseUrl}/the-woodlands`, priority: 0.8, frequency: 'monthly' },
...
async function generate() {
  ...
  console.log('Static sitemap generated at public/sitemap-static.xml and public/sitemap_index.xml')
}
